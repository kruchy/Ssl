...
#include "../SSLDesktop/sslserver.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_sslServer_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_sslServer_t qt_meta_stringdata_sslServer = {
    {
QT_MOC_LITERAL(0, 0, 9), // "sslServer"
QT_MOC_LITERAL(1, 10, 7), // "logText"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 6), // "string"
QT_MOC_LITERAL(4, 26, 9), // "readyRead"
QT_MOC_LITERAL(5, 36, 10), // "clientRead"
QT_MOC_LITERAL(6, 47, 15), // "clientEncrypted"
QT_MOC_LITERAL(7, 63, 10), // "onSslError"
QT_MOC_LITERAL(8, 74, 16), // "QList<QSslError>"
QT_MOC_LITERAL(9, 91, 4) // "list"

    },
    "sslServer\0logText\0\0string\0readyRead\0"
    "clientRead\0clientEncrypted\0onSslError\0"
...
void sslServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->logText((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->readyRead(); break;
        case 2: _t->clientRead(); break;
        case 3: _t->clientEncrypted(); break;
        case 4: _t->onSslError((*reinterpret_cast< QList<QSslError>(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (sslServer::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&sslServer::logText)) {
                *result = 0;
            }
        }
        {
            typedef void (sslServer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&sslServer::readyRead)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void sslServer::logText(QString _t1)
{
